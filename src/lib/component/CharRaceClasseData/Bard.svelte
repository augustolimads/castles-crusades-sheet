<div class="race-class-info">
  <p>Decipher script(INT): decipher unfamiliar writing</p>
  <p>
    Exalt(CHA): inspire companions by exaltation. +2 to any one attribute check
  </p>
  ...
  <p>
    Armours: Breastplates, chain shirt, cuir bouille, greek ensemble, hide,
